 ...
 */
public class ComentBeritaDialogFragment extends DialogFragment{

    public static final String ARG_PARAM_BERITA = "param_berita";
    ...
    public static ComentBeritaDialogFragment newInstance(Berita berita, UserSession user) {
        ComentBeritaDialogFragment fragment = new ComentBeritaDialogFragment();
        Bundle args = new Bundle();
        args.putParcelable(ARG_PARAM_BERITA, Parcels.wrap(berita));
        args.putParcelable(ARG_PARAM_USER, Parcels.wrap(user));
        fragment.setArguments(args);
        return fragment;
    }

    public ComentBeritaDialogFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            berita = (Berita) Parcels.unwrap(getArguments().getParcelable(ARG_PARAM_BERITA));
            List<Coment> com = berita.trnBeritaComents;
            comments.addAll(com);
        }
    ...
    private void postComent(String coment){
        ...
        params.put("TrnBeritaComent[berita_id]", berita.id);
        params.put("TrnBeritaComent[coment]", coment);
        ...
        Call<Coment> call = service.createComentBerita(params);
