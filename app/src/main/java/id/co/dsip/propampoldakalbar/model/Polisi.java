...
public class Polisi {
    ...
    public Polisi(String id, String nama, String nrp, String hp, String pas_foto, String foto_kta, String token, String fcm_key, Pangkat pangkat, Jabatan jabatan, Penempatan penempatan, UserCreator user) {
        this.id = id;
        this.nama = nama;
        this.nrp = nrp;
        this.hp = hp;
    ...
    public UserCreator getUser() {
        return user;
    }

    public void setUser(UserCreator user) {
        this.user = user;
    }
}
